...
function buildPrompt(data) {
  ...
  return [
    ...
    ((color || isDefaultAccent) ? "" : "Weave in " + accent + " only as a subtle supporting accent, not the dominant color."),
    (color ? "" : ("Strongly lean the entire color palette toward " + scheme + ".")),
